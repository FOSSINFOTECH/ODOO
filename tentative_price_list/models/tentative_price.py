...
class TentativePrice(models.Model):
    ...
    number = fields.Char('Sequence', default='New')
    name =  fields.Char("Name", required=True)
    reference = fields.Char("Reference")
    state = fields.Selection([('draft', 'Draft'), ('confirmed', 'confirmed')], default='draft')
    tentative_price_ids =  fields.One2many('tentative.price.lines', 'tentative_price_id', "Tentative Price Reference")
...
class PurchaseOrder(models.Model):
    ...
    tpl_pricelist_id = fields.Many2one('tentative.price', 'Tentative List Name')
